...
<div class="contentbox">
	...
	<td><?php echo $row['status'];echo !empty($row['sn_id']) ? '&nbsp;<font color=blue>&nbsp;['.$row['shoppingname'].']物流单:<a style="color:#fe0000" href="http://m.kuaidi100.com/index_all.html?type='.trim($row['shipping_code']).'&postid='.trim($row['sn_id']).'&callbackurl='.urlencode( SITE_URL.'m/user.php?act=orderlist').'" target="_blank">'.$row['sn_id'].'</a></font>' : '';?></td>
	<td>
